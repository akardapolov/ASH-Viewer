...
public class SyntaxUtilities
{
	...
	public static SyntaxStyle[] getDefaultSyntaxStyles()
	{
		...
		styles[Token.COMMENT1] = new SyntaxStyle(new Color(0,128,128),true,false);
		styles[Token.COMMENT2] = new SyntaxStyle(new Color(0,128,128),true,false);
		...
		styles[Token.INVALID] = new SyntaxStyle(Color.LIGHT_GRAY,false,true);
