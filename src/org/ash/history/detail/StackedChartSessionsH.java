 ...
 * 
 */
public class StackedChartSessionsH {
	 ...
	 */
    public StackedChartSessionsH(ASHDatabaseH database0) {
     ...
     */
    public ChartPanel createChartPanel(Double beginTime,Double endTime) throws DatabaseException {
    	createDataset(beginTime, endTime);
     ...
     * @throws DatabaseException the database exception
     */
    private void createDataset(Double beginTime,Double endTime) throws DatabaseException {
    	dataset = new CategoryTableXYDataset();
        this.database.loadDataToChartPanelDataSet_Sessions_All(dataset, beginTime, endTime);
    }
