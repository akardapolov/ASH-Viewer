...
public class CategoryTableXYDataset extends AbstractIntervalXYDataset
    ...
    /**
     * Removes an row from the dataset.
     *
     * @param x  the x-value.
     */
    public void removeRow(Number x) {
    	//System.out.println( this.values.getRowCount()+"rowcount");
    	this.values.removeRow((Comparable) x);
        fireDatasetChanged();
